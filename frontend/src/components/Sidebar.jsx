  ...
  return (
    <>
      ...
      <button 
        ...
        className="md:hidden fixed top-4 right-4 z-[60] p-2 bg-[#2563EB] text-white rounded-md shadow-lg"
      >
      ...
      {/* Sidebar Container - Added responsive transform classes */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#f8fafc] text-slate-700 border-r border-slate-200 flex flex-col shadow-lg shrink-0 transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 ${isMobileOpen ? 'translate-x-0' : '-translate-x-full'} font-sans`}>
                        ...
                        return (
                          <div
                            ...
                            onClick={() => {
                              ...
                              setIsMobileOpen(false); // Close sidebar on mobile after clicking sub-item
                            }}
